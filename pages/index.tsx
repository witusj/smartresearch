    ...
    <div className='page-container'>
      ...
      <div className={styles.main}>
        <Intro
          ...
          lead="Het doel van onderzoek is waardevolle kennis te genereren m.b.t. complexe vraagstukken en duurzame oplossingsrichtingen. We definiëren voor deze context onderzoek als het gehele proces van genereren, delen en verwerken van kennis en informatie. Door studenten
            van te voren goed te laten nadenken over dit proces en te ondersteunen bij de inrichting ervan wordt gestreefd naar een adequate kwaliteit van uitvoering en uitkomsten. De informatie op deze website dient ter inspiratie voor docenten, bedrijfscoaches en studenten bij het ontwerp en uitvoering van onderzoek en geeft aanknopingspunten voor feedback en assessment."
        />
        <Paragraph
